...
public class CodeExecutorContext {
	...
	public void addProcessedFileNames(List<String> fileNames) {
		List<String> processedFileNames = (List<String>) this.context.computeIfAbsent(PROCESSED_FILE_NAMES_KEY,
				k -> new ArrayList<>());
	...
	public List<File> getInputFiles() {
		List<Map<String, Object>> fileMaps = (List<Map<String, Object>>) this.sessionState.getOrDefault(INPUT_FILE_KEY,
				new ArrayList<>());
	...
	public void addInputFiles(List<File> inputFiles) {
		List<Map<String, Object>> fileMaps = (List<Map<String, Object>>) this.sessionState
			.computeIfAbsent(INPUT_FILE_KEY, k -> new ArrayList<>());
		for (File inputFile : inputFiles) {
			fileMaps.add(objectMapper.convertValue(inputFile, new TypeReference<Map<String, Object>>() {
			}));
		}
	}
	...
	public int getErrorCount(String invocationId) {
		Map<String, Integer> errorCounts = (Map<String, Integer>) this.sessionState.get(ERROR_COUNT_KEY);
		if (errorCounts == null) {
			return 0;
		}
	...
	public void incrementErrorCount(String invocationId) {
		Map<String, Integer> errorCounts = (Map<String, Integer>) this.sessionState.computeIfAbsent(ERROR_COUNT_KEY,
				k -> new HashMap<>());
	...
	public void updateCodeExecutionResult(String invocationId, String code, String resultStdout, String resultStderr) {
		Map<String, List<Map<String, Object>>> codeExecutionResults = (Map<String, List<Map<String, Object>>>) this.sessionState
			.computeIfAbsent(CODE_EXECUTION_RESULTS_KEY, k -> new HashMap<>());
		List<Map<String, Object>> resultsForInvocation = codeExecutionResults.computeIfAbsent(invocationId,
				k -> new ArrayList<>());

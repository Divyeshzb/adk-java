...
public class LoadMemoryTool extends FunctionTool {
	...
	public LoadMemoryTool() {
		super(/* instance= */ null, getLoadMemoryMethod(), /* isLongRunning= */ false,
	 ...
	 */
	public static Single<LoadMemoryResponse> loadMemory(@Annotations.Schema(name = "query") String query,
			ToolContext toolContext) {
		return toolContext.searchMemory(query)
	...
	public Completable processLlmRequest(LlmRequest.Builder llmRequestBuilder, ToolContext toolContext) {
		return super.processLlmRequest(llmRequestBuilder, toolContext)
			.doOnComplete(() -> llmRequestBuilder.appendInstructions(ImmutableList.of("""

...
public interface BaseToolset extends AutoCloseable {
	 ...
	 * lifecycle or when the toolset is no longer needed. Implementations should ensure
	 * that any open connections, files, or other managed resources are properly released
	 * to prevent leaks.
	 */
	@Override
	...
	/**
	 * Helper method to be used by implementers that returns true if the given tool is in
	 * the provided list of tools of if testing against the given ToolPredicate returns
	 ...
	 */
	default boolean isToolSelected(BaseTool tool, Optional<Object> toolFilter,

 ...
 *
 * <p>
 * The loop continues until a sub-agent escalates, or until the maximum number of
 * iterations is reached (if specified).
 */
public class LoopAgent extends BaseAgent {
	 ...
	 * @param maxIterations Optional termination condition: maximum number of loop
	 * iterations.
	 ...
	 */
	private LoopAgent(String name, String description, List<? extends BaseAgent> subAgents,
			Optional<Integer> maxIterations, List<Callbacks.BeforeAgentCallback> beforeAgentCallback,
	...
	public static class Builder {
		...
		public LoopAgent build() {
			...
			return new LoopAgent(name, description, subAgents, maxIterations, beforeAgentCallback, afterAgentCallback);
		}
	...
	protected Flowable<Event> runLiveImpl(InvocationContext invocationContext) {
		return Flowable.error(new UnsupportedOperationException("runLive is not defined for LoopAgent yet."));
	}

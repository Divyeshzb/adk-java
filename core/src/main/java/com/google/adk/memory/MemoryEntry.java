...
public abstract class MemoryEntry {
	...
	/**
	 * Returns the timestamp when the original content of this memory happened, or null if
	 * not set.
	 *
	 * <p>
	...
	public abstract static class Builder {
		...
		/**
		 * A convenience method to set the timestamp from an {@link Instant} object,

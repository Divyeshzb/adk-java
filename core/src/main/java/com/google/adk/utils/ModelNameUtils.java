...
public class ModelNameUtils {
	...
	private static final Pattern PATH_PATTERN = Pattern
		.compile("^projects/[^/]+/locations/[^/]+/publishers/[^/]+/models/(.+)$");

	private static final Pattern APIGEE_PATTERN = Pattern.compile("^apigee/(?:[^/]+/)?(?:[^/]+/)?(.+)$");
	 ...
	 * @param modelString Either a simple model name like "gemini-2.5-pro" or a path-based
	 * model name like "projects/.../models/gemini-2.0-flash-001"

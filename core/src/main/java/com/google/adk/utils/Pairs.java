...
public final class Pairs {
	...
	/**
	 * Returns a new {@code ConcurrentHashMap} containing two mappings. This method
	 * leverages {@code
	...
	/**
	 * Returns a new {@code ConcurrentHashMap} containing three mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	...
	/**
	 * Returns a new {@code ConcurrentHashMap} containing four mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	...
	/**
	 * Returns a new {@code ConcurrentHashMap} containing five mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	...
	/**
	 * Returns a new {@code ConcurrentHashMap} containing six mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	 ...
	 * @return a {@code ConcurrentHashMap} containing the specified mappings
	 * @throws IllegalArgumentException if there are any duplicate keys (behavior
	 * inherited from Map.of)
	 * @throws NullPointerException if any key or value is {@code null} (behavior
	 * inherited from Map.of)
	 */
	public static <K, V> ConcurrentHashMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6,
			V v6) {
		return new ConcurrentHashMap<>(ImmutableMap.of(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6));
	}

	/**
	 * Returns a new {@code ConcurrentHashMap} containing seven mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	...
	public static <K, V> ConcurrentHashMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6,
			V v6, K k7, V v7) {
		return new ConcurrentHashMap<>(ImmutableMap.of(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6, k7, v7));
	}

	/**
	 * Returns a new {@code ConcurrentHashMap} containing eight mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	...
	public static <K, V> ConcurrentHashMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6,
		...
		return new ConcurrentHashMap<>(ImmutableMap.of(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6, k7, v7, k8, v8));
	}

	/**
	 * Returns a new {@code ConcurrentHashMap} containing nine mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	...
	/**
	 * Returns a new {@code ConcurrentHashMap} containing ten mappings. This method
	 * leverages {@code
	 * java.util.Map.of} for initial validation.
	 * @param <K> the {@code ConcurrentHashMap}'s key type
	 * @param <V> the {@code ConcurrentHashMap}'s value type
	...
	public static <K, V> ConcurrentHashMap<K, V> of(K k1, V v1, K k2, V v2, K k3, V v3, K k4, V v4, K k5, V v5, K k6,
		...
		return new ConcurrentHashMap<>(
				ImmutableMap.of(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5, k6, v6, k7, v7, k8, v8, k9, v9, k10, v10));
	}

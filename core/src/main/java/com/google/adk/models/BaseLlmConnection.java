...
public interface BaseLlmConnection {
	 ...
	 *
	 * <p>
	 * You call this method right after setting up the model connection. The model will
	 * respond if the last content is from user, otherwise it will wait for new user input
	 * before responding.
	 */
	 ...
	 *
	 * <p>
	 * The model may not respond immediately upon receiving the blob. It will do voice
	 * activity detection and decide when to respond.
	 */
